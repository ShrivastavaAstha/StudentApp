              ...
              <div className="border-t pt-4">
                ...
                <div className="flex space-x-2">
                  <button
                    ...
                    className="flex-1 flex items-center justify-center space-x-1 bg-indigo-600 text-white py-2 px-3 rounded-lg hover:bg-blue-700 transition-colors text-sm"
                  >
                  ...
                  <button
                    ...
                    className="flex-1 flex items-center justify-center space-x-1 bg-green-800 text-white py-2 px-3 rounded-lg hover:bg-green-700 transition-colors text-sm"
                  >
                    <Video size={16} />
                    <span>Meet</span>
                  </button>
